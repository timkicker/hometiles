 ...
 *
 * the emergency catch appears when HomeTiles twice in a row does not get as far as drawing.
...
class EmergencyReachTest {
    ...
    private val source = Quelltext.file("dev/kicker/hometiles/safety/EmergencyScreen.kt").readText()
