 ...
 *
 * HomeTiles deliberately makes no sound on this screen. the row of dots is a `liveRegion` and
...
class SilentWrongPinTest {
    ...
    fun `the error message is a liveRegion`() {
        val gate = Quelltext.withoutComments("dev/kicker/hometiles/ui/PinGate.kt")
