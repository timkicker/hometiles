 ...
 * HomeTiles is built for eyes that tell colours apart badly.
 *
...
class SelectionAnnouncementTest {
    ...
    private val editor = Quelltext.withoutComments("dev/kicker/hometiles/tiles/TileEditorActivity.kt")
