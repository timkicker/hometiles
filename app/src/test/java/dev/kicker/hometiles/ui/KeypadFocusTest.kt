...
class KeypadFocusTest {
    ...
    private val keypad = Quelltext.withoutComments("dev/kicker/hometiles/ui/BigKeypad.kt")
    private val gate = Quelltext.withoutComments("dev/kicker/hometiles/ui/PinGate.kt")
