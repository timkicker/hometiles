...
class StateSpokenTest {
    ...
    private val row = Quelltext.withoutComments("dev/kicker/hometiles/ui/BigRow.kt")
    ...
    fun `the message list says what is unread`() {
        val list = Quelltext.withoutComments("dev/kicker/hometiles/sms/SmsActivity.kt")
        assertTrue(
    ...
    fun `the call log says the direction`() {
        val list = Quelltext.withoutComments("dev/kicker/hometiles/phone/DialerActivity.kt")
        assertTrue(
    ...
    /**
     * on the pin screen there was no feedback at all: HomeTiles deliberately makes no sound, and
    ...
    fun `the row of dots says how many digits stand there`() {
        val keypad = Quelltext.withoutComments("dev/kicker/hometiles/ui/BigKeypad.kt")
