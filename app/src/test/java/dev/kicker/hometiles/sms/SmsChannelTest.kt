 ...
 * HomeTiles therefore creates a channel per vibration length (`sms-500`) and deletes the others
...
class SmsChannelTest {
    ...
    private val source = Quelltext.withoutComments("dev/kicker/hometiles/sms/SmsNotifications.kt")
