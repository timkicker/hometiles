...
class DeadTileTest {
    ...
    private val source = Quelltext.withoutComments("dev/kicker/hometiles/MainActivity.kt")
    ...
    fun `the editor gets the cell that was tapped`() {
        val calls = Quelltext.file("dev/kicker/hometiles/MainActivity.kt").readLines()
