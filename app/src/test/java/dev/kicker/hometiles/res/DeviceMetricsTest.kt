...
import dev.kicker.hometiles.ui.labelSizeSp
import dev.kicker.hometiles.ui.labelZoneDp
...
class DeviceMetricsTest {
    ...
    fun `the call screen arithmetic takes the same height`() {
        ...
        val test = Quelltext.file("dev/kicker/hometiles/phone/CallerPhotoSizeTest.kt").readText()
