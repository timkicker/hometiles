...
class NoAnswerTest {
    ...
    private val repository = Quelltext.file("dev/kicker/hometiles/shortcuts/ShortcutRepository.kt")
    private val editor = Quelltext.file("dev/kicker/hometiles/tiles/TileEditorActivity.kt")
