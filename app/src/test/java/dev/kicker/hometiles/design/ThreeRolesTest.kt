 ...
 *
 * HomeTiles can hold three roles of the system: home screen, phone, messages. two of them stood
 * in the settings tree with their state and a way to change it. the third stood only in the
 * message screen, and there only while HomeTiles did **not** hold it (`sms_not_default`).
 * whoever held it learned that nowhere, and could not get rid of it from here.
 *
 * noticed on 03.09.2026, when HomeTiles got the role: the tree said HomeTiles was the phone app and
 * said nothing about the messages.
 */
class ThreeRolesTest {

    private val tree = Quelltext.withoutComments("dev/kicker/hometiles/settings/SettingsActivity.kt")
