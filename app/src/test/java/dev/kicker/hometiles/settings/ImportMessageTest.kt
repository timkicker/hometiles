 ...
 *
 * a file HomeTiles had written itself two minutes earlier was turned away as no backup when
...
class ImportMessageTest {
    ...
    private val source = Quelltext.file("dev/kicker/hometiles/settings/ImportActivity.kt").readText()
