 ...
 *
 * a backup from a newer HomeTiles carries fields this version does not know; they fall away on
...
class WarnBeforeLoadingTest {
    ...
    private val importing = Quelltext.withoutComments("dev/kicker/hometiles/settings/ImportActivity.kt")
