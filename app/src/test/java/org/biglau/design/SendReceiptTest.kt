 ...
 * passed. until 03.09.2026 `null` stood there: BigLau reported "sent" because the call had
...
class SendReceiptTest {
    ...
    private val sending = Quelltext.withoutComments("org/biglau/sms/SmsActivity.kt")
    ...
    fun `the receipt turns the failure into something visible`() {
        val receiver = Quelltext.withoutComments("org/biglau/sms/SmsSentReceiver.kt")
        assertTrue(
