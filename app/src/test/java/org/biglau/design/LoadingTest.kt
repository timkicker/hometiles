...
class LoadingTest {
    ...
    private val calls = Quelltext.file("org/biglau/phone/DialerActivity.kt").readText()
    ...
    fun `the contact list has kept its loading hint`() {
        val contacts = Quelltext.file("org/biglau/contacts/ContactsActivity.kt").readText()
