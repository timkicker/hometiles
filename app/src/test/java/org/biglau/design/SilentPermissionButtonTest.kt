...
class SilentPermissionButtonTest {
    ...
    private val askers = mapOf(
        "org/biglau/MainActivity.kt" to "the signal tile",
        "org/biglau/contacts/ContactsActivity.kt" to "the contact list",
        "org/biglau/phone/DialerActivity.kt" to "the call log",
        "org/biglau/sms/SmsActivity.kt" to "the message list",
    )
