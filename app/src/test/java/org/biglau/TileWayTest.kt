 ...
 *
 * tapping a tile whose app is gone makes BigLau say so and open the tile editor - the way
...
class TileWayTest {
    ...
    private val main = Quelltext.withoutComments("org/biglau/MainActivity.kt")
