...
class JumpTargetTest {
    ...
    fun `all three lists of screens filter alike`() {
        ...
        val places = mapOf(
            "org/biglau/tiles/SwipeChain.kt" to "swiping",
            "org/biglau/tiles/ScreenEdits.kt" to "the unreachable screens",
            "org/biglau/tiles/TileEditorActivity.kt" to "picking the jump target",
        )
