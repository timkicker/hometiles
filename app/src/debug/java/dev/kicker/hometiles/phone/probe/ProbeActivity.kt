 ...
 *
 *     adb shell am start -n dev.kicker.hometiles.debug/dev.kicker.hometiles.phone.probe.ProbeActivity
 *
...
class ProbeActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val registered = runCatching {
            telecom.registerPhoneAccount(
                PhoneAccount.builder(account, "HomeTiles probe call")
    ...
    private fun report(text: String) {
        android.util.Log.i("HomeTiles", text)
    }
}
