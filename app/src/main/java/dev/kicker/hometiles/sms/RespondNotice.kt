 ...
 *
 * another app asked HomeTiles to send one; HomeTiles does not send it by itself (see
 * [dev.kicker.hometiles.sms.RespondViaMessageService]). so that this is not a silent nothing, the
