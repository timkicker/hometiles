...
internal fun MessagesSettingsList(
    ...
    LazyColumn(verticalArrangement = Arrangement.spacedBy(4.dp)) {
        ...
        // what HomeTiles cannot do: an mms is not in the notice, it is fetched from the mmsc
        // over the data connection, and HomeTiles has no INTERNET permission. the no network
        // access line in the README is what carries the price here.
        //
        // two versions, because only the default app fetches an mms: once that is HomeTiles, a
        ...
        item {
            Text(
                ...
                // sms role held, HomeTiles is not the sms app is plainly wrong.
